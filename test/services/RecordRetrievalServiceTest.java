...
public class RecordRetrievalServiceTest {
	 ...
	 *  
	 *  This test queries the database with a null argument for name. 
	 ...
	 *  
	 *  This test queries the database with a non-existent name. 
	 *  Expects to receive an empty list of dog records.
	 */
	@Test
	public void queryRecordsByNameNonExistentRecordTest( ){
		
		List<DogRecord> dogRecords = recordService.queryRecordsByName(NON_EXISTENT_DOG_NAME);
