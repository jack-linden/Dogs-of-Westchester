...
public class DogTest {
	...
	/*	
	 * This tests the equals() method of the Dog class
	 * pass in two dogs with different location, name, breed and color information but has the same idNumber
	 * expects that the two dogs are the same
	 */
	@Test
	 ...
	 * creates an initialized dog object, and changes the idNumber to an invalid
	 * expects that the idNumber will be set to a default value
	 */
	@Test
	 ...
	 * creates an initialized dog object, and changes the sex to an invalid value
	 * expects that the sex will be set to a default value
	 */
	@Test
